	...
	Если ЗначениеЗаполнено(Объект.ИдентификаторКонтрагента) Тогда
		Если ВыбранноеЗначение <> Объект.Контрагент Тогда
			...
			Если Ответ = КодВозвратаДиалога.Да Тогда
				...
				ЭлектронныеДокументыКлиентПереопределяемый.УстановитьОтображениеПредупреждения("ИдентификаторКонтрагента", ЭтаФорма);
			КонецЕсли;
		КонецЕсли;
	Иначе
		УстановитьИдентификатор("Контрагент", ВыбранноеЗначение);
	...
	Если ЗначениеЗаполнено(Объект.ИдентификаторОрганизации) Тогда
		Если ВыбранноеЗначение <> Объект.Организация Тогда
			...
			Если Ответ = КодВозвратаДиалога.Да Тогда
				...
				ЭлектронныеДокументыКлиентПереопределяемый.УстановитьОтображениеПредупреждения("ИдентификаторОрганизации", ЭтаФорма);
			КонецЕсли;
		КонецЕсли;
	Иначе
		УстановитьИдентификатор("Организация", ВыбранноеЗначение);
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.Пояснение.Видимость					 = НЕ Объект.ЭтоТиповое;
