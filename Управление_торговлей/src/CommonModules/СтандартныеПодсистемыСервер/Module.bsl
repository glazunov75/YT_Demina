...
Процедура ЗаполнитьОписаниеОшибки(ИнформацияОбОшибке, ОшибкаУстановкиМонопольногоРежима = Ложь)
	
	ОписаниеОшибки = СтандартныеПодсистемыПовтИсп.ОшибкаПередЗапускомПрограммы();
	
	ОписаниеОшибки.Вставить("ЕстьОшибка", Истина);
	Если ОшибкаУстановкиМонопольногоРежима Тогда
		ОписаниеОшибки.Вставить("ОшибкаУстановкиМонопольногоРежима", Истина);
	КонецЕсли;
	
	Если ТипЗнч(ИнформацияОбОшибке) = Тип("ИнформацияОбОшибке") Тогда
		ОписаниеОшибки.Вставить("ИнформацияОбОшибке",           ИнформацияОбОшибке);
		ОписаниеОшибки.Вставить("КраткоеПредставлениеОшибки",   КраткоеПредставлениеОшибки(ИнформацияОбОшибке));
		ОписаниеОшибки.Вставить("ПодробноеПредставлениеОшибки", ПодробноеПредставлениеОшибки(ИнформацияОбОшибке));
	Иначе
		ОписаниеОшибки.Вставить("КраткоеПредставлениеОшибки",   ИнформацияОбОшибке);
		ОписаниеОшибки.Вставить("ПодробноеПредставлениеОшибки", ИнформацияОбОшибке);
	КонецЕсли;
