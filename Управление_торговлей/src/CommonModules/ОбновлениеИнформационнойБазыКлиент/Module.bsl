...
Процедура ПоказатьОписаниеИзмененийСистемы()
	...
	Если ПараметрыРаботыКлиента.ПоказатьОписаниеИзмененийСистемы Или ВывестиОписаниеИзмененийДляАдминистратора = Истина Тогда
		ВывестиОписаниеИзмененийДляАдминистратора = Ложь;
		
		ПараметрыФормы = Новый Структура;
		
		Если ТипЗнч(ПараметрыРаботыКлиентаПриОбновлении) = Тип("Структура")
		   И ПараметрыРаботыКлиентаПриОбновлении.Свойство("ВремяНачалаОбновления")
		   И ПараметрыРаботыКлиентаПриОбновлении.Свойство("ВремяОкончанияОбновления") Тогда
			
			ПараметрыФормы.Вставить("ВремяНачалаОбновления",    ПараметрыРаботыКлиентаПриОбновлении.ВремяНачалаОбновления);
			ПараметрыФормы.Вставить("ВремяОкончанияОбновления", ПараметрыРаботыКлиентаПриОбновлении.ВремяОкончанияОбновления);
		КонецЕсли;
