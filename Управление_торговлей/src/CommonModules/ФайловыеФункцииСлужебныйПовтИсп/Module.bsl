...
Процедура ДобавитьНастройкиРаботыСФайлами(ОбщиеНастройки, ПерсональныеНастройки)
	...
	ЗапрещатьЗагрузкуФайловПоРасширению = Неопределено;
...
Функция СписокЗапрещенныхРасширений()
	...
	Возврат "COM EXE BAT CMD VBS VBE JS JSE WSF WSH SCR";
	
КонецФункции

Функция СписокРасширенийФайловOpenDocument()
	
	Возврат "ODT OTT ODP OTP ODS OTS ODC OTC ODF OTF ODM OTH SDW STW SXW STC SXC SDC SDD STI";
