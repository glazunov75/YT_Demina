...
Процедура УстановитьНастройкиРежимаОтладкиДляОбработки(ОбработкаОбменаДанными, СтруктураНастроекОбмена)
	...
	ЗаполнитьЗначенияСвойств(ОбработкаОбменаДанными, СтруктураНастроекОбмена);
	
	РежимПротоколированияОбменаДанными = Неопределено;
	
	Если СтруктураНастроекОбмена.Свойство("РежимПротоколированияОбменаДанными", РежимПротоколированияОбменаДанными)
		И РежимПротоколированияОбменаДанными Тогда
