...
////////////////////////////////////////////////////////////////////////////////
// Обработчики выгрузки конвертации УправлениеТорговлей --> БухгалтерияПредприятия {b9b896f9-c8f2-11e2-905f-c86000df10de}                                                                            
// 
...
Процедура ПКО_АдресныеСокращения_ПередВыгрузкойОбъекта(ФайлОбмена, Источник, ВходящиеДанные, ИсходящиеДанные, ИмяПКО, ПКО,
	ВыгруженныеОбъекты, Отказ, КлючВыгружаемыхДанных, ЗапоминатьВыгруженные,
	НеЗамещатьОбъектПриЗагрузке, ВсеОбъектыВыгружены, ТолькоПолучитьУзелСсылки,
	Приемник, РежимЗаписи, РежимПроведения, НеСоздаватьЕслиНеНайден) Экспорт
...
Процедура ПКО_АдресныеСокращения_ПриВыгрузкеОбъекта(ФайлОбмена, Источник, ВходящиеДанные, ИсходящиеДанные, ИмяПКО, ПКО,
...
Процедура ПКО_КлассификаторСтранМира_ПередВыгрузкойОбъекта(ФайлОбмена, Источник, ВходящиеДанные, ИсходящиеДанные, ИмяПКО, ПКО,
	ВыгруженныеОбъекты, Отказ, КлючВыгружаемыхДанных, ЗапоминатьВыгруженные,
	НеЗамещатьОбъектПриЗагрузке, ВсеОбъектыВыгружены, ТолькоПолучитьУзелСсылки,
	Приемник, РежимЗаписи, РежимПроведения, НеСоздаватьЕслиНеНайден) Экспорт
...
Процедура ПКО_ПоступлениеДопРасходов_ПриВыгрузкеОбъекта(ФайлОбмена, Источник, ВходящиеДанные, ИсходящиеДанные, ИмяПКО, ПКО,
	ВыгруженныеОбъекты, КлючВыгружаемыхДанных, Отказ, СтандартнаяОбработка,
	Приемник, УзелСсылки) Экспорт
...
Процедура ПКО_СчетФактураВыданный_ПередВыгрузкойОбъекта(ФайлОбмена, Источник, ВходящиеДанные, ИсходящиеДанные, ИмяПКО, ПКО,
	ВыгруженныеОбъекты, Отказ, КлючВыгружаемыхДанных, ЗапоминатьВыгруженные,
	НеЗамещатьОбъектПриЗагрузке, ВсеОбъектыВыгружены, ТолькоПолучитьУзелСсылки,
	Приемник, РежимЗаписи, РежимПроведения, НеСоздаватьЕслиНеНайден) Экспорт
	...
	//	Для Каждого СтрокаТЧ Из Источник.ДокументыОснования Цикл
	//		Если ЗначениеЗаполнено(СтрокаТЧ.ДокументОснование) Тогда
...
Процедура ПКС_КорректировкаДолга_ВидОперации_ПередВыгрузкойСвойства_2_18(ФайлОбмена, Источник, Приемник, ВходящиеДанные, ИсходящиеДанные,
	ПКС, ПКО, ОбъектКоллекции, Отказ, Значение, ТипПриемника, ИмяПКО,
	ИмяПКОВидСубконто, Пусто, Выражение, УзелКоллекцииСвойств, НеЗамещать,
	ВыгрузитьОбъект) Экспорт
...
Процедура ПКС_СчетНаОплатуПокупателю_Товары_Цена_ПередВыгрузкойСвойства_9_22(ФайлОбмена, Источник, Приемник, ВходящиеДанные, ИсходящиеДанные,
	ПКС, ПКО, ОбъектКоллекции, Отказ, Значение, ТипПриемника, ИмяПКО,
	ИмяПКОВидСубконто, Пусто, Выражение, УзелКоллекцииСвойств, НеЗамещать,
	ВыгрузитьОбъект) Экспорт
...
Процедура ПКС_СчетНаОплатуПокупателю_Товары_Количество_ПередВыгрузкойСвойства_16_22(ФайлОбмена, Источник, Приемник, ВходящиеДанные, ИсходящиеДанные,
	ПКС, ПКО, ОбъектКоллекции, Отказ, Значение, ТипПриемника, ИмяПКО,
	ИмяПКОВидСубконто, Пусто, Выражение, УзелКоллекцииСвойств, НеЗамещать,
	ВыгрузитьОбъект) Экспорт
...
Процедура ПКС_СчетФактураВыданный_ДокументыОснования_ДатаИсправленияИсходногоДокумента_ПередВыгрузкойСвойства_55_19(ФайлОбмена, Источник, Приемник, ВходящиеДанные, ИсходящиеДанные,
	ПКС, ПКО, ОбъектКоллекции, Отказ, Значение, ТипПриемника, ИмяПКО,
	ИмяПКОВидСубконто, Пусто, Выражение, УзелКоллекцииСвойств, НеЗамещать,
	ВыгрузитьОбъект) Экспорт
...
Процедура ПКС_СчетФактураВыданный_ДокументыОснования_ДатаИсходногоДокумента_ПередВыгрузкойСвойства_56_19(ФайлОбмена, Источник, Приемник, ВходящиеДанные, ИсходящиеДанные,
	ПКС, ПКО, ОбъектКоллекции, Отказ, Значение, ТипПриемника, ИмяПКО,
	ИмяПКОВидСубконто, Пусто, Выражение, УзелКоллекцииСвойств, НеЗамещать,
	ВыгрузитьОбъект) Экспорт
...
Процедура ПКС_СчетФактураВыданный_ДокументыОснования_НомерИсправленияИсходногоДокумента_ПередВыгрузкойСвойства_57_19(ФайлОбмена, Источник, Приемник, ВходящиеДанные, ИсходящиеДанные,
	ПКС, ПКО, ОбъектКоллекции, Отказ, Значение, ТипПриемника, ИмяПКО,
	ИмяПКОВидСубконто, Пусто, Выражение, УзелКоллекцииСвойств, НеЗамещать,
	ВыгрузитьОбъект) Экспорт
...
Процедура ПКС_СчетФактураВыданный_ДокументыОснования_НомерИсходногоДокумента_ПередВыгрузкойСвойства_58_19(ФайлОбмена, Источник, Приемник, ВходящиеДанные, ИсходящиеДанные,
	ПКС, ПКО, ОбъектКоллекции, Отказ, Значение, ТипПриемника, ИмяПКО,
	ИмяПКОВидСубконто, Пусто, Выражение, УзелКоллекцииСвойств, НеЗамещать,
	ВыгрузитьОбъект) Экспорт
...
Процедура ПКС_СчетФактураВыданный_ДокументыОснования_СуммаНДСУвеличение_ПередВыгрузкойСвойства_59_19(ФайлОбмена, Источник, Приемник, ВходящиеДанные, ИсходящиеДанные,
	ПКС, ПКО, ОбъектКоллекции, Отказ, Значение, ТипПриемника, ИмяПКО,
	ИмяПКОВидСубконто, Пусто, Выражение, УзелКоллекцииСвойств, НеЗамещать,
	ВыгрузитьОбъект) Экспорт

	Значение = Источник.СуммаНДСУвеличение;

КонецПроцедуры

Процедура ПКС_СчетФактураВыданный_ДокументыОснования_СуммаНДСУменьшение_ПередВыгрузкойСвойства_60_19(ФайлОбмена, Источник, Приемник, ВходящиеДанные, ИсходящиеДанные,
	ПКС, ПКО, ОбъектКоллекции, Отказ, Значение, ТипПриемника, ИмяПКО,
	ИмяПКОВидСубконто, Пусто, Выражение, УзелКоллекцииСвойств, НеЗамещать,
	ВыгрузитьОбъект) Экспорт

	Значение = Источник.СуммаНДСУменьшение;

КонецПроцедуры

Процедура ПКС_СчетФактураВыданный_ДокументыОснования_СуммаУвеличение_ПередВыгрузкойСвойства_61_19(ФайлОбмена, Источник, Приемник, ВходящиеДанные, ИсходящиеДанные,
	ПКС, ПКО, ОбъектКоллекции, Отказ, Значение, ТипПриемника, ИмяПКО,
	ИмяПКОВидСубконто, Пусто, Выражение, УзелКоллекцииСвойств, НеЗамещать,
	ВыгрузитьОбъект) Экспорт

	Значение = Источник.СуммаУвеличение;

КонецПроцедуры

Процедура ПКС_СчетФактураВыданный_ДокументыОснования_СуммаУменьшение_ПередВыгрузкойСвойства_62_19(ФайлОбмена, Источник, Приемник, ВходящиеДанные, ИсходящиеДанные,
	ПКС, ПКО, ОбъектКоллекции, Отказ, Значение, ТипПриемника, ИмяПКО,
	ИмяПКОВидСубконто, Пусто, Выражение, УзелКоллекцииСвойств, НеЗамещать,
	ВыгрузитьОбъект) Экспорт

	Значение = Источник.СуммаУменьшение;

КонецПроцедуры

Процедура ПКС_СчетФактураВыданный_ДокументыОснования_УчитыватьИсправлениеИсходногоДокумента_ПередВыгрузкойСвойства_63_19(ФайлОбмена, Источник, Приемник, ВходящиеДанные, ИсходящиеДанные,
	ПКС, ПКО, ОбъектКоллекции, Отказ, Значение, ТипПриемника, ИмяПКО,
	ИмяПКОВидСубконто, Пусто, Выражение, УзелКоллекцииСвойств, НеЗамещать,
	ВыгрузитьОбъект) Экспорт

	Значение = Источник.УчитыватьИсправлениеИсходногоДокумента;

КонецПроцедуры

Процедура ПКС_СчетФактураПолученный_ДокументыОснования_ДатаИсправленияИсходногоДокумента_ПередВыгрузкойСвойства_43_21(ФайлОбмена, Источник, Приемник, ВходящиеДанные, ИсходящиеДанные,
	ПКС, ПКО, ОбъектКоллекции, Отказ, Значение, ТипПриемника, ИмяПКО,
	ИмяПКОВидСубконто, Пусто, Выражение, УзелКоллекцииСвойств, НеЗамещать,
	ВыгрузитьОбъект) Экспорт
...
Процедура ПКС_СчетФактураПолученный_ДокументыОснования_ДатаИсходногоДокумента_ПередВыгрузкойСвойства_44_21(ФайлОбмена, Источник, Приемник, ВходящиеДанные, ИсходящиеДанные,
	ПКС, ПКО, ОбъектКоллекции, Отказ, Значение, ТипПриемника, ИмяПКО,
	ИмяПКОВидСубконто, Пусто, Выражение, УзелКоллекцииСвойств, НеЗамещать,
	ВыгрузитьОбъект) Экспорт
...
Процедура ПКС_СчетФактураПолученный_ДокументыОснования_НомерИсправленияИсходногоДокумента_ПередВыгрузкойСвойства_45_21(ФайлОбмена, Источник, Приемник, ВходящиеДанные, ИсходящиеДанные,
	ПКС, ПКО, ОбъектКоллекции, Отказ, Значение, ТипПриемника, ИмяПКО,
	ИмяПКОВидСубконто, Пусто, Выражение, УзелКоллекцииСвойств, НеЗамещать,
	ВыгрузитьОбъект) Экспорт
...
Процедура ПКС_СчетФактураПолученный_ДокументыОснования_НомерИсходногоДокумента_ПередВыгрузкойСвойства_46_21(ФайлОбмена, Источник, Приемник, ВходящиеДанные, ИсходящиеДанные,
	ПКС, ПКО, ОбъектКоллекции, Отказ, Значение, ТипПриемника, ИмяПКО,
	ИмяПКОВидСубконто, Пусто, Выражение, УзелКоллекцииСвойств, НеЗамещать,
	ВыгрузитьОбъект) Экспорт
...
Процедура ПКС_СчетФактураПолученный_ДокументыОснования_СуммаНДСУвеличение_ПередВыгрузкойСвойства_47_21(ФайлОбмена, Источник, Приемник, ВходящиеДанные, ИсходящиеДанные,
	ПКС, ПКО, ОбъектКоллекции, Отказ, Значение, ТипПриемника, ИмяПКО,
	ИмяПКОВидСубконто, Пусто, Выражение, УзелКоллекцииСвойств, НеЗамещать,
	ВыгрузитьОбъект) Экспорт
...
Процедура ПКС_СчетФактураПолученный_ДокументыОснования_СуммаНДСУменьшение_ПередВыгрузкойСвойства_48_21(ФайлОбмена, Источник, Приемник, ВходящиеДанные, ИсходящиеДанные,
	ПКС, ПКО, ОбъектКоллекции, Отказ, Значение, ТипПриемника, ИмяПКО,
	ИмяПКОВидСубконто, Пусто, Выражение, УзелКоллекцииСвойств, НеЗамещать,
	ВыгрузитьОбъект) Экспорт
...
Процедура ПКС_СчетФактураПолученный_ДокументыОснования_СуммаУвеличение_ПередВыгрузкойСвойства_49_21(ФайлОбмена, Источник, Приемник, ВходящиеДанные, ИсходящиеДанные,
	ПКС, ПКО, ОбъектКоллекции, Отказ, Значение, ТипПриемника, ИмяПКО,
	ИмяПКОВидСубконто, Пусто, Выражение, УзелКоллекцииСвойств, НеЗамещать,
	ВыгрузитьОбъект) Экспорт
...
Процедура ПКС_СчетФактураПолученный_ДокументыОснования_СуммаУменьшение_ПередВыгрузкойСвойства_50_21(ФайлОбмена, Источник, Приемник, ВходящиеДанные, ИсходящиеДанные,
	ПКС, ПКО, ОбъектКоллекции, Отказ, Значение, ТипПриемника, ИмяПКО,
	ИмяПКОВидСубконто, Пусто, Выражение, УзелКоллекцииСвойств, НеЗамещать,
	ВыгрузитьОбъект) Экспорт
...
Процедура ПКС_СчетФактураПолученный_ДокументыОснования_УчитыватьИсправлениеИсходногоДокумента_ПередВыгрузкойСвойства_51_21(ФайлОбмена, Источник, Приемник, ВходящиеДанные, ИсходящиеДанные,
	ПКС, ПКО, ОбъектКоллекции, Отказ, Значение, ТипПриемника, ИмяПКО,
	ИмяПКОВидСубконто, Пусто, Выражение, УзелКоллекцииСвойств, НеЗамещать,
	ВыгрузитьОбъект) Экспорт
...
Процедура ПВД_АдресныеСокращения_ПередОбработкойПравила(Отказ, ИмяПКО, Правило, ИсходящиеДанные, ВыборкаДанных) Экспорт

	Отказ = Истина;

КонецПроцедуры

Процедура ПВД_АдресныеСокращения_ПередВыгрузкойОбъекта(ФайлОбмена, Отказ, ИмяПКО, Правило, ВходящиеДанные, ИсходящиеДанные, Объект) Экспорт
	...
	//СтрокаОтбора.Имя = "Уровень";
	//СтрокаОтбора.Значение = Объект.Уровень;
	//СтрокаОтбора.Использование = Истина;
	
	//СтрокаОтбора = Отбор.Добавить();
	//СтрокаОтбора.Имя = "Код";
	//СтрокаОтбора.Значение = Объект.Код;
	//СтрокаОтбора.Использование = Истина;
	
	//// Создание таблицы состава набора записей
	//Строки = Новый ТаблицаЗначений;
	//Строки.Колонки.Добавить("Ссылка");
	//Строки.Колонки.Добавить("Уровень");
	//Строки.Колонки.Добавить("Код");
	//Строки.Колонки.Добавить("Наименование");
	//Строки.Колонки.Добавить("Сокращение");
	
	//// Заполнение набора
	//СтрокаНабора = Строки.Добавить();
	//СтрокаНабора.Уровень = Объект.Уровень;
	//СтрокаНабора.Код = Объект.Код;
	//СтрокаНабора.Наименование = Объект.Наименование;
	//СтрокаНабора.Сокращение = Объект.Сокращение;
	...
	//ВыгрузитьРегистр(НаборЗаписей, , , Истина, "АдресныеСокращения");
	//Отказ = Истина;
...
Процедура ПВД_КорректировкаПоступления_ПередВыгрузкойОбъекта(ФайлОбмена, Отказ, ИмяПКО, Правило, ВходящиеДанные, ИсходящиеДанные, Объект) Экспорт

	//Если ТипЗнч(Объект.ДокументПоступления) = Тип("ДокументСсылка.ОтражениеПоступленияТоваровИУслугНДС") Тогда
	//	Отказ = Истина;
...
Процедура ПВД_КорректировкаРеализации_ПередВыгрузкойОбъекта(ФайлОбмена, Отказ, ИмяПКО, Правило, ВходящиеДанные, ИсходящиеДанные, Объект) Экспорт
